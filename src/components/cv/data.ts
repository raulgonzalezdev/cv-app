export const data = {
  es: {
    ...
    interests: ['Beisbol', 'Idiomas', 'Running'],
    certificates: [
  ...
  en: {
    ...
    extract: 'Con más de 20 años de experiencia en el ámbito tecnológico...',
    mainSkills: ['1 Python', '2 Java', '3 SQL'],
    experience: [
      {
        id: 1,
        company: 'Central IT ',
